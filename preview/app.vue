      ...
      componentProps: {
        ...
        list: [
          ...
          },
          {
            title: '标题',
            tip: '我是副标题',
            cover: 'https://gw.alipayobjects.com/zos/rmsportal/iHEPGHUfgKMuIJhnmYCk.png',
            url: '',
            tag: '留学快汇'
          },
          {
            title: '标题',
            tip: '我是副标题',
            cover: 'https://gw.alipayobjects.com/zos/rmsportal/VJeIDTUhhgZbEOAZcXeE.png',
            url: '',
            tag: '商务出行'
          },
          {
            title: '标题',
            tip: '我是副标题',
            cover: 'https://gw.alipayobjects.com/zos/rmsportal/MsBVFalmPzPZWnovieJz.png',
            url: '',
            tag: '资产配置'
          },
          {
            title: '标题',
            tip: '我是副标题',
            cover: 'https://gw.alipayobjects.com/zos/rmsportal/IJPHFytoWJjCBrKTQxhx.png',
            url: '',
            tag: '代办签证'
          }
        ]
